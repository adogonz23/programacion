...
public class FileTest {
    ...
    @Test
    public void xmlToAlimentoTest(){
        Persister persistente = new Persister();
        try {
            File file= new File("src/resources/alimento2.xml");
            Alimento alimento = persistente.read(Alimento.class, file);
            Assertions.assertEquals(nombre, alimento.getNombre());
        } catch (Exception e) {
